...
SECRET_KEY = 'django-insecure-6&*&_@$j(g@z9_w26mr_5*&d-6_q-d3)47lud86rr5k5u-bjjd'
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://127.0.0.1:6379/1",  # i will change to redis://redis:6379/1 if using Docker network
        "OPTIONS": {
